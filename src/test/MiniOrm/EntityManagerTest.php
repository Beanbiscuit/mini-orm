...
class EntityManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInstantiateAndPersist()
    {
        ...
        $oPersistEntity = $oEntityManager->find('MiniOrm\Entity\ApplicationUser', $oEntity2->getId());
        ...
        $aCollection = $oEntityManager->findAll('MiniOrm\Entity\ApplicationUser');
        print_r($aCollection);
...
//
        ...
        $oRemovedEntity1 = $oEntityManager->find('MiniOrm\Entity\ApplicationUser', $oEntity2->getId());
