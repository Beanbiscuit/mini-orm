...
class AnnotationMapping implements EntityMapping
{
    ...
    public function mapEntity($sEntityName)
    {
        ...
        //Only attempt to map the provided object if it is marked as an ORM entity.
     ...
     *
     * @param string $sClassName The full class name of the entity whose properties are to be mapped.
    ...
    /**
     * Parses the primary key annotation for the provided entity and extracts annotation attributes.
     * 
