...
/**
 * Configuration class reads package configurations from a file.
 * 
...
class Configuration
{
    ...
    /**
     * Private constructor, class cannot be directly instantiated.
     */
     ...
     * 
     * Configurations are stored in a class attributes as an array.
     * 
     * @param string $sPath
